...
sw = LineClient("aanlove52@gmail.com"," mahadewi68")
...
def help1():
    ...
    helpMessage1 = "🔰 " + key + " [TΣRXβΩTS🔀MΣΠU]🔰\n" + \
                  ...
                  "🔰🔰🔰「」↪  ʙʏ: тegυн s ↩ 🔰🔰🔰\n" + \
                  "🔀 Creator:  https://line.me/ti/p/~black_ghost_killer"
                                            ...
                                            try:
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        ...
                                                        try:
                                                            kc.kickoutFromGroup(op.param1,[op.param2])
                                                            kuc.cancelGroupInvitation(op.param1,[op.param2]) #
                                                            kc.inviteIntoGroup(op.param1,[op.param3])
                                                            kd.acceptGroupInvitation(op.param1)    
                                                        except:
                                                            pass
                    ...
                    if msg_id in msg_dict:
                        if msg_dict[msg_id]["from"]:
                           if msg_dict[msg_id]["text"] == 'Gambarnya dibawah':
                                ...
                                ret_ += "\n✅тerXвoт-ѕadιѕ"
                                ret_ += "\n✅Creator:  line.me/ti/p/~black_ghost_killer" 
...
"TAR-TER-TAR-TOR\n"
		...
		"╚╩╝╚╝╚╝━╚╝━╚╝╚╝\n"
		"━━━━━━━━━━━━━━━\n"
">>>lain x jangan sok songong ama kami>><\ningat  yee,,klo lu dendam cari kami\n<<<<<<<<<>>\nhttp://line.me/ti/p/~aanlove52@gmail.com\nhttp://line.me/ti/p/~yukiaan41@gail.com")
                               targets = []
                               for g in gs.members:
                                   if _name in g.displayName:
                                       targets.append(g.mid)
...
#===========Hiburan============#
                          ...
                          if msg._from in admin:
                                ...
                                with requests.session() as web:
                                    ...
                                    r = web.get("https://aanlove/api/premium/fs.php?apikey=apikey_saintsbot&id={}".format(urllib.parse.quote(anu)))
                                    data = r.text
                                    data = json.loads(data)
...
while True:
    try:
        ...
        pass
ndMention(msg.to, sender, "「 Status Sticker Check 」\n", " [ ON ]\nSilahkan kirim stickernya,\nJika sudah selesai, ketik sticker off")
