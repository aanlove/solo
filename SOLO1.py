...
print("\black ghost BOTS SUKCESS LOGIN.....\n")

poll = LinePoll(cl)
call = cl
creator = ["a77b2c853b7a6b3a196ee4029b89542fda3ccac3"]
owner = ["a77b2c853b7a6b3a196ee4029b89542fda3ccac3"]
admin = ["a77b2c853b7a6b3a196ee4029b89542fda3ccac3"]
staff = ["a77b2c853b7a6b3a196ee4029b89542fda3ccac3"]
lineProfile = cl.getProfile()
mid = cl.getProfile(a77b2c853b7a6b3a196ee4029b89542fda3ccac3).mid
KAC = [cl]
Bots = [mid]
Saints = admin + staff
...
def help():
    ...
    key = key.title()
    helpMessage = "🔑❂͜͡➣ " + key + " [black_ghost]\n" + \
                   "🔑❂͜͡➣" + key + "✰SADIS BOTS✰\n" + \
                  "🔑❂͜͡➣ " + key + "ʜᴇʟᴘ\n" + \
                  "🔑❂͜͡➣ " + key + "ʜᴇʟᴘ1\n" + \
                  "🔑❂͜͡➣ " + key + "ʜᴇʟᴘ2\n" + \
...
def help1():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "🔑❂͜͡➣ " + key + " [ BLACK GHOST]\n" + \
                  "🔑❂͜͡➣ " + key + "ᴛᴀɢᴀʟʟ/ɴᴀʜ\n" + \
                  "🔑❂͜͡➣ " + key + "ɢɪɴғᴏ\n" + \
                  "🔑❂͜͡➣ " + key + "ᴏᴘᴇɴ\n" + \
                  "🔑❂͜͡➣ " + key + "ᴄʟᴏsᴇ\n" + \
...
def help2():
    ...
    helpMessage2= "      「✭SETTING SASIS BOTS✭」\n" + \
                  ...
                  " [🔑SADIS BOTS\n" + \
                  "🔑Creator:  line.me/ti/p/~bkack_ghost_killer"
...
#ADD Bots
               if msg.contentType == 13:
                 ...
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        Bots.remove(msg.contentMetadata["black_ghost_killer"])
